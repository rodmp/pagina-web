...
export default ({ hotDares, lastDares }) => {
	const renderHotDare = dare => `<p style="margin:0;margin-bottom:8px;padding:0;"><a href="${propOr('', 'href')(dare)}" style="text-decoration:none;color:#1976d2;">${propOr('Untitled', 'title')(dare)}</a></p>`
	const renderLastDare = dare => `<p style="margin:0;margin-bottom:8px;padding:0;"><a href="${propOr('', 'href')(dare)}" style="text-decoration:none;color:#1976d2;">${propOr('Untitled', 'title')(dare)}</a></p>`
                ...
                <tbody>
                  ...
                  <tr>
                    <td style="margin:0; padding:0;" width="100%">
                      ...
                      <p style="margin:0;padding:0;">Visit <a href="${ourUrl}" style="text-decoration:none;color:#1976d2;">${ourUrl}</a></p>
                  ...
                  <tr>
                    <td style="margin:0; padding:0;" width="100%">
                      ...
                      <p style="margin:0;padding:0;">Check out the Dares in our <a href="${marketplaceUrl}" style="text-decoration:none;color:#1976d2;">marketplace</a>, if you see one you like, pledge to it to let the streamer know you want to see it. You can do this by hitting the “Pledge” button inside each dare.</p>
                    </td>
                  </tr>
                  ...
                  <tr>
                    <td align="center" style="margin:0;padding:0;">
                      <a href="${marketplaceUrl}" style="display:inline-block;font-family:'Source Sans Pro',sans-serif;font-weight:700;font-size:18px;line-height:1.39;padding:11px 0;background:#800080;text-align:center;width:360px;color:#ffffff;text-decoration:none;border-radius:4px;" >Go to Marketplace</a>
                    </td>
                  </tr>
